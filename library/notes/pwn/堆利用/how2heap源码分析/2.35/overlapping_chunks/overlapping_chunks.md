...
```
	...
	p3 = malloc(0x80 - 8);
```
![[notes/pwn/堆利用/how2heap源码分析/2.35/overlapping_chunks/图/屏幕截图 2026-02-15 153905.png]]
![[notes/pwn/堆利用/how2heap源码分析/2.35/overlapping_chunks/图/屏幕截图 2026-02-15 154436.png]]
...
```
![[notes/pwn/堆利用/how2heap源码分析/2.35/overlapping_chunks/图/屏幕截图 2026-02-15 155307.png]]
![[notes/pwn/堆利用/how2heap源码分析/2.35/overlapping_chunks/图/屏幕截图 2026-02-15 155628.png]]
## 3.
```
	free(p2);
```
![[notes/pwn/堆利用/how2heap源码分析/2.35/overlapping_chunks/图/屏幕截图 2026-02-15 154013.png]]
![[notes/pwn/堆利用/how2heap源码分析/2.35/overlapping_chunks/图/屏幕截图 2026-02-15 154753.png]]

## 4.
```
	p4 = malloc(evil_region_size);
```
![[notes/pwn/堆利用/how2heap源码分析/2.35/overlapping_chunks/图/屏幕截图 2026-02-15 154055.png]]
![[notes/pwn/堆利用/how2heap源码分析/2.35/overlapping_chunks/图/屏幕截图 2026-02-15 160554.png]]
# 攻击流程
1. 需要能覆盖chunk的size位。
2. 如下布局堆区，并覆盖目标chunk的prev chunk的size位，为更大size（至少覆盖下一个chunk的fd，bk，nextsize指针部分）。
	![[notes/pwn/堆利用/how2heap源码分析/2.35/overlapping_chunks/图/屏幕截图 2026-02-15 154436.png]]
3. `free(prev_chunk)`，并`malloc(覆盖size大小)`，这时获得两个重叠的chunk指针（p3，p4）。
	![[notes/pwn/堆利用/how2heap源码分析/2.35/overlapping_chunks/图/屏幕截图 2026-02-15 160554.png]]