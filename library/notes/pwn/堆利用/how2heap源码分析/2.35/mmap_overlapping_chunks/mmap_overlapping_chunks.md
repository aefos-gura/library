...
long long* top_ptr = malloc(0x100000);
```
![[notes/pwn/堆利用/how2heap源码分析/2.35/mmap_overlapping_chunks/图/屏幕截图 2026-02-15 190317.png]]
## 2.
```
long long* mmap_chunk_2 = malloc(0x100000);
```
![[notes/pwn/堆利用/how2heap源码分析/2.35/mmap_overlapping_chunks/图/屏幕截图 2026-02-15 190344.png]]
## 3.
```
long long* mmap_chunk_3 = malloc(0x100000);
```
![[notes/pwn/堆利用/how2heap源码分析/2.35/mmap_overlapping_chunks/图/屏幕截图 2026-02-15 190452.png]]
## 4.
```
mmap_chunk_3[-1] = (0xFFFFFFFFFD & mmap_chunk_3[-1]) + (0xFFFFFFFFFD & mmap_chunk_2[-1]) | 2;
```
![[notes/pwn/堆利用/how2heap源码分析/2.35/mmap_overlapping_chunks/图/屏幕截图 2026-02-15 190615.png]]
![[屏幕截图 2026-02-15 190945.png]]
## 5.
```
free(mmap_chunk_3);
```
![[notes/pwn/堆利用/how2heap源码分析/2.35/mmap_overlapping_chunks/图/屏幕截图 2026-02-15 190634.png]]
## 6.
```
long long* overlapping_chunk = malloc(0x300000);
```
![[notes/pwn/堆利用/how2heap源码分析/2.35/mmap_overlapping_chunks/图/屏幕截图 2026-02-15 190653.png]]
# 攻击流程
